...
const (
	Query_Params_FullMethodName      = "/lumera.claim.Query/Params"
	Query_ClaimRecord_FullMethodName = "/lumera.claim.Query/ClaimRecord"
	Query_ListClaimed_FullMethodName = "/lumera.claim.Query/ListClaimed"
)
...
func (c *queryClient) ClaimRecord(ctx context.Context, in *QueryClaimRecordRequest, opts ...grpc.CallOption) (*QueryClaimRecordResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ClaimRecord_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListClaimed(ctx context.Context, in *QueryListClaimedRequest, opts ...grpc.CallOption) (*QueryListClaimedResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListClaimed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) ListClaimed(context.Context, *QueryListClaimedRequest) (*QueryListClaimedResponse, error) {
...
func _Query_ListClaimed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ListClaimed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
