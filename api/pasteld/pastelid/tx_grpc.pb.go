...
const (
	Msg_UpdateParams_FullMethodName   = "/pasteld.pastelid.Msg/UpdateParams"
	Msg_CreatePastelId_FullMethodName = "/pasteld.pastelid.Msg/CreatePastelId"
)
...
func (c *msgClient) CreatePastelId(ctx context.Context, in *MsgCreatePastelId, opts ...grpc.CallOption) (*MsgCreatePastelIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_CreatePastelId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) CreatePastelId(context.Context, *MsgCreatePastelId) (*MsgCreatePastelIdResponse, error) {
...
func _Msg_CreatePastelId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_CreatePastelId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
