...
func (app *App) registerIBCModules(
	...
	var (
		transferStack      ibcporttypes.IBCModule = ibctransfer.NewIBCModule(app.TransferKeeper)
		icaControllerStack ibcporttypes.IBCModule = icacontroller.NewIBCMiddleware(app.ICAControllerKeeper)
		icaHostStack       ibcporttypes.IBCModule = icahost.NewIBCModule(app.ICAHostKeeper)
	)
