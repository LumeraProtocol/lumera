...
| **Unit**        | app/openrpc, tools/openrpcgen        | 15                                                                      | High — spec validation, HTTP serving, CORS origin filtering, code generator, namespace registration                                                                                                                                                                                |
...
| **Unit**        | x/evmigration                        | 103                                                                     | Excellent — auth/bank/staking/distribution/authz/feegrant/supernode/claim/action migration, validator migration (including evidence, metrics stale-key deletion, account history, third-party withdraw addr preservation), signature verification, genesis, queries, params, message validation, rate limiting, pre-checks |
|                       |                                      |                                                                         |                                                                                                                                                                                                                                                                                     |
