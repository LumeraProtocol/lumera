...
export const QueryClaimRecordResponse: MessageFns<QueryClaimRecordResponse> = {
  encode(message: QueryClaimRecordResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.record !== undefined) {
      ClaimRecord.encode(message.record, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): QueryClaimRecordResponse {
    return { record: isSet(object.record) ? ClaimRecord.fromJSON(object.record) : undefined };
  },

  toJSON(message: QueryClaimRecordResponse): unknown {
    const obj: any = {};
    if (message.record !== undefined) {
      obj.record = ClaimRecord.toJSON(message.record);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryClaimRecordResponse>, I>>(object: I): QueryClaimRecordResponse {
    ...
    message.record = (object.record !== undefined && object.record !== null)
      ? ClaimRecord.fromPartial(object.record)
      : undefined;
    return message;
  },
};
...
export const QueryServiceName = "lumera.claim.Query";
