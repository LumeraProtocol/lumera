...
| [x] | Node operator EVM configuration guide    | High               | `guides/evm-integration/user-guides/node-evm-config-guide.md`             |
...
| [x] | MetaMask + Remix smart contract guide                   | Medium   | `guides/evm-integration/remix-guide.md`        |
| [x] | OpenRPC Playground guide                                | Medium   | `guides/evm-integration/openrpc-playground.md` |
