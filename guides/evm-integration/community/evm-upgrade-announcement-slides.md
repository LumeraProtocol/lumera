...
**Render**: `npx @marp-team/marp-cli guides/evm-integration/community/evm-upgrade-announcement-slides.md --pdf`
...
Detailed guide: [EVM Legacy Account Migration - User Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/migration.md)
...
Detailed guide: [MetaMask Configuration Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/metamask-configuration.md)
...
- [Testing Smart Contracts on Lumera with Remix IDE](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/guides/remix-guide.md)
- [OpenRPC Discovery and Playground Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/guides/openrpc-playground.md)
- [Precompiles Overview](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/precompiles/precompiles.md)
...
Rollout reference: [Rollout Plan](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/architecture/rollout.md)
...
Start here: [Lumera EVM User Guides](https://github.com/LumeraProtocol/lumera/tree/v1.20.3/guides/evm-integration/user-guides)
