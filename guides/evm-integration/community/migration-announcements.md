...
https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/migration.md
...
📖 Runbooks:
🛡️ Validators: https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/validator-migration.md
🖥️ Supernodes: https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/supernode-migration.md
```
