...
**Publishing note**: links target the GitHub `v1.20.0` tag under `guides/evm-integration`; update them if a docs site URL becomes available.
...
- [Rollout Plan](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/architecture/rollout.md)
- [Lumera EVM User Guides](https://github.com/LumeraProtocol/lumera/tree/v1.20.3/guides/evm-integration/user-guides)
- [Node Operator EVM Configuration Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/node-evm-config-guide.md)
- [Validator Operator EVM Migration Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/validator-migration.md)
- [Supernode Operator EVM Migration Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/supernode-migration.md)
- [Hermes IBC Relayer EVM Migration Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/relayer-migration.md)
...
Detailed runbook: [Validator Operator EVM Migration Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/validator-migration.md)
...
Detailed runbook: [Supernode Operator EVM Migration Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/supernode-migration.md)
...
Detailed runbook: [Hermes IBC Relayer EVM Migration Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/relayer-migration.md)
...
Detailed runbook: [Node Operator EVM Configuration Guide](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/user-guides/node-evm-config-guide.md)
...
- Public user quickstart: [Lumera EVM Migration Quickstart](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/community/user-migration-quickstart.md)
- Community announcement deck source: [Lumera EVM Upgrade Announcement Deck](https://github.com/LumeraProtocol/lumera/blob/v1.20.3/guides/evm-integration/community/evm-upgrade-announcement-slides.md)
- Full guide hub: [Lumera EVM User Guides](https://github.com/LumeraProtocol/lumera/tree/v1.20.3/guides/evm-integration/user-guides)
