...
func init() {
	...
	md_Evidence = File_lumera_supernode_evidence_proto.Messages().ByName("Evidence")
...
func (x *Evidence) slowProtoReflect() protoreflect.Message {
	mi := &file_lumera_supernode_evidence_proto_msgTypes[0]
...
func (x *fastReflection_Evidence) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "lumera.supernode.Evidence.reporter_address":
		return x.ReporterAddress != ""
	case "lumera.supernode.Evidence.validator_address":
		return x.ValidatorAddress != ""
	case "lumera.supernode.Evidence.action_id":
		return x.ActionId != ""
	case "lumera.supernode.Evidence.evidence_type":
		return x.EvidenceType != ""
	case "lumera.supernode.Evidence.description":
		return x.Description != ""
	case "lumera.supernode.Evidence.severity":
		return x.Severity != uint64(0)
	case "lumera.supernode.Evidence.height":
		return x.Height != int32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lumera.supernode.Evidence"))
		}
		panic(fmt.Errorf("message lumera.supernode.Evidence does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Evidence) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message lumera.supernode.Evidence does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Evidence) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "lumera.supernode.Evidence.reporter_address":
		panic(fmt.Errorf("field reporter_address of message lumera.supernode.Evidence is not mutable"))
	case "lumera.supernode.Evidence.validator_address":
		panic(fmt.Errorf("field validator_address of message lumera.supernode.Evidence is not mutable"))
	case "lumera.supernode.Evidence.action_id":
		panic(fmt.Errorf("field action_id of message lumera.supernode.Evidence is not mutable"))
	case "lumera.supernode.Evidence.evidence_type":
		panic(fmt.Errorf("field evidence_type of message lumera.supernode.Evidence is not mutable"))
	case "lumera.supernode.Evidence.description":
		panic(fmt.Errorf("field description of message lumera.supernode.Evidence is not mutable"))
	case "lumera.supernode.Evidence.severity":
		panic(fmt.Errorf("field severity of message lumera.supernode.Evidence is not mutable"))
	case "lumera.supernode.Evidence.height":
		panic(fmt.Errorf("field height of message lumera.supernode.Evidence is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: lumera.supernode.Evidence"))
		}
...
func (x *fastReflection_Evidence) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in lumera.supernode.Evidence", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Evidence) Descriptor() ([]byte, []int) {
	return file_lumera_supernode_evidence_proto_rawDescGZIP(), []int{0}
}
...
var File_lumera_supernode_evidence_proto protoreflect.FileDescriptor

var file_lumera_supernode_evidence_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x6c, 0x75, 0x6d, 0x65, 0x72, 0x61, 0x2f, 0x73, 0x75, 0x70, 0x65, 0x72, 0x6e, 0x6f,
	0x64, 0x65, 0x2f, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x10, 0x6c, 0x75, 0x6d, 0x65, 0x72, 0x61, 0x2e, 0x73, 0x75, 0x70, 0x65, 0x72, 0x6e,
	...
	0xbd, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x6c, 0x75, 0x6d, 0x65, 0x72, 0x61, 0x2e, 0x73,
...
var (
	file_lumera_supernode_evidence_proto_rawDescOnce sync.Once
	file_lumera_supernode_evidence_proto_rawDescData = file_lumera_supernode_evidence_proto_rawDesc
)

func file_lumera_supernode_evidence_proto_rawDescGZIP() []byte {
	file_lumera_supernode_evidence_proto_rawDescOnce.Do(func() {
		file_lumera_supernode_evidence_proto_rawDescData = protoimpl.X.CompressGZIP(file_lumera_supernode_evidence_proto_rawDescData)
	})
	return file_lumera_supernode_evidence_proto_rawDescData
}

var file_lumera_supernode_evidence_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_lumera_supernode_evidence_proto_goTypes = []interface{}{
	(*Evidence)(nil), // 0: lumera.supernode.Evidence
}
var file_lumera_supernode_evidence_proto_depIdxs = []int32{
...
func init() { file_lumera_supernode_evidence_proto_init() }
func file_lumera_supernode_evidence_proto_init() {
	if File_lumera_supernode_evidence_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_lumera_supernode_evidence_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_lumera_supernode_evidence_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_lumera_supernode_evidence_proto_goTypes,
		DependencyIndexes: file_lumera_supernode_evidence_proto_depIdxs,
		MessageInfos:      file_lumera_supernode_evidence_proto_msgTypes,
	}.Build()
	File_lumera_supernode_evidence_proto = out.File
	file_lumera_supernode_evidence_proto_rawDesc = nil
	file_lumera_supernode_evidence_proto_goTypes = nil
	file_lumera_supernode_evidence_proto_depIdxs = nil
}
