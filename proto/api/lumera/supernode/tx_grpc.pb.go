...
const (
	Msg_UpdateParams_FullMethodName        = "/lumera.supernode.Msg/UpdateParams"
	Msg_RegisterSupernode_FullMethodName   = "/lumera.supernode.Msg/RegisterSupernode"
	Msg_DeregisterSupernode_FullMethodName = "/lumera.supernode.Msg/DeregisterSupernode"
	Msg_StartSupernode_FullMethodName      = "/lumera.supernode.Msg/StartSupernode"
	Msg_StopSupernode_FullMethodName       = "/lumera.supernode.Msg/StopSupernode"
	Msg_UpdateSupernode_FullMethodName     = "/lumera.supernode.Msg/UpdateSupernode"
)
...
func (c *msgClient) RegisterSupernode(ctx context.Context, in *MsgRegisterSupernode, opts ...grpc.CallOption) (*MsgRegisterSupernodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_RegisterSupernode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeregisterSupernode(ctx context.Context, in *MsgDeregisterSupernode, opts ...grpc.CallOption) (*MsgDeregisterSupernodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_DeregisterSupernode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) StartSupernode(ctx context.Context, in *MsgStartSupernode, opts ...grpc.CallOption) (*MsgStartSupernodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_StartSupernode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) StopSupernode(ctx context.Context, in *MsgStopSupernode, opts ...grpc.CallOption) (*MsgStopSupernodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_StopSupernode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateSupernode(ctx context.Context, in *MsgUpdateSupernode, opts ...grpc.CallOption) (*MsgUpdateSupernodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UpdateSupernode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
