...
func (endpoint *Endpoint) CreateClient() (err error) {
	...
	endpoint.ClientID, err = ibctst.ParseClientIDFromEvents(res.Events)
	require.NoError(endpoint.Chain.TB, err)
...
func (endpoint *Endpoint) ConnOpenInit() error {
	...
	endpoint.ConnectionID, err = ibctst.ParseConnectionIDFromEvents(res.Events)
	require.NoError(endpoint.Chain.TB, err)
...
func (endpoint *Endpoint) ChanOpenInit() error {
	...
	endpoint.ChannelID, err = ibctst.ParseChannelIDFromEvents(res.Events)
	require.NoError(endpoint.Chain.TB, err)
