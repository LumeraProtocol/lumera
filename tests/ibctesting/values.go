...
const (
	...
	DefaultChannelVersion = ibcmock.Version
...
var (
	...
	MockAcknowledgement = ibcmock.MockAcknowledgement.Acknowledgement()
	MockPacketData      = ibcmock.MockPacketData
	MockFailPacketData  = ibcmock.MockFailPacketData
