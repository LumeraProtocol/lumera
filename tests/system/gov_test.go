...
func TestGovVoteByContract(t *testing.T) {
	...
	communityPoolBalance := chain.Balance(app.AccountKeeper.GetModuleAccount(chain.GetContext(), distributiontypes.ModuleName).GetAddress(), sdk.DefaultBondDenom)
	...
	for name, spec := range specs {
		t.Run(name, func(t *testing.T) {
			...
			system.MustExecViaReflectContract(t, chain, contractAddr, voteMsg)
