...
func TestGroupWithContract(t *testing.T) {
	...
	contractAddr := system.InstantiateStargateReflectContract(t, chain)
	...
	rsp = system.MustExecViaStargateReflectContract(t, chain, contractAddr, propMsg)
...
func TestGroupWithNewReflectContract(t *testing.T) {
	...
	rsp = system.MustExecViaAnyReflectContract(t, chain, contractAddr, propMsg)
	var execRsp types.MsgExecuteContractResponse
	chain.UnwrapExecTXResult(rsp, &execRsp)
