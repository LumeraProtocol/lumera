...
func TestGroupWithContract(t *testing.T) {
	...
	contractAddr := wasmtest.InstantiateStargateReflectContract(t, chain)
	...
	rsp = wasmtest.MustExecViaStargateReflectContract(t, chain, contractAddr, propMsg)
...
func TestGroupWithNewReflectContract(t *testing.T) {
	...
	rsp = wasmtest.MustExecViaAnyReflectContract(t, chain, contractAddr, propMsg)
	var execRsp types.MsgExecuteContractResponse
	chain.UnwrapExecTXResult(rsp, &execRsp)
