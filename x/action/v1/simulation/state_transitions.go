...
func SimulateActionExpiration(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		if action == nil {
			return simtypes.NoOpMsg(types2.ModuleName, sdk.MsgTypeURL(&types2.MsgRequestAction{}), "failed to find or create pending action"), nil, nil
		}
		...
		if action.State != actionapi.ActionState_ACTION_STATE_PENDING {
			return simtypes.NoOpMsg(types2.ModuleName, sdk.MsgTypeURL(&types2.MsgRequestAction{}),
		...
		return simtypes.NewOperationMsg(&types2.MsgRequestAction{}, true, "action_expiration_success"), nil, nil
	}
}
