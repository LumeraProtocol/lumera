...
func TestScaleInt64TowardZero(t *testing.T) {
	...
	require.Equal(t, int64(math.MaxInt64/2), scaleInt64TowardZero(math.MaxInt64, 50, 100))
	require.Equal(t, int64(math.MinInt64/2), scaleInt64TowardZero(math.MinInt64, 50, 100))
}
