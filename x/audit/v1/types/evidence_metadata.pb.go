...
type FinalizationEvidenceMetadata struct {
	...
	ExpectedFinalizerAddress string `protobuf:"bytes,2,opt,name=expected_finalizer_address,json=expectedFinalizerAddress,proto3" json:"expected_finalizer_address,omitempty"`
	// reason is optional human-readable context.
...
func (m *FinalizationEvidenceMetadata) GetExpectedFinalizerAddress() string {
	if m != nil {
		return m.ExpectedFinalizerAddress
	}
	return ""
}
...
var fileDescriptor_09b57e4c2349ab91 = []byte{
	...
	0x05, 0x23, 0x97, 0x8c, 0x5b, 0x66, 0x5e, 0x62, 0x4e, 0x66, 0x15, 0x76, 0x5b, 0x22, 0xb8, 0xa4,
	...
	0x0d, 0xa6, 0x17, 0xaa, 0x40, 0x28, 0x8c, 0x4b, 0x2a, 0xb5, 0xa2, 0x20, 0x35, 0x19, 0xbb, 0xc1,
	0x4c, 0x04, 0x0c, 0x96, 0x80, 0xe9, 0xc5, 0x30, 0x17, 0xe1, 0x55, 0x66, 0x64, 0xaf, 0x3a, 0x69,
	0x9d, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x13, 0x1e, 0xcb,
	0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x40, 0x05, 0x22, 0xde, 0x4a,
	0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0x11, 0x60, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x0c,
	0xfa, 0x2c, 0xf1, 0xd7, 0x01, 0x00, 0x00,
}
...
func (m *FinalizationEvidenceMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExpectedFinalizerAddress) > 0 {
		i -= len(m.ExpectedFinalizerAddress)
		copy(dAtA[i:], m.ExpectedFinalizerAddress)
		i = encodeVarintEvidenceMetadata(dAtA, i, uint64(len(m.ExpectedFinalizerAddress)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *FinalizationEvidenceMetadata) Size() (n int) {
	...
	l = len(m.ExpectedFinalizerAddress)
	if l > 0 {
		n += 1 + l + sovEvidenceMetadata(uint64(l))
	}
	l = len(m.Reason)
...
func (m *FinalizationEvidenceMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExpectedFinalizerAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExpectedFinalizerAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Reason", wireType)
