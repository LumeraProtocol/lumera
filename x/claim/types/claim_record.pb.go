...
type ClaimRecord struct {
	...
	VestedTier  uint32                                   `protobuf:"varint,6,opt,name=vestedTier,proto3" json:"vestedTier"`
}
...
func (m *ClaimRecord) GetDestAddress() string {
	if m != nil {
...
func (m *ClaimRecord) GetVestedTier() uint32 {
	if m != nil {
		return m.VestedTier
	}
	return 0
...
var fileDescriptor_e72b918829c6d483 = []byte{
	...
	,
}
...
func (m *ClaimRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.VestedTier != 0 {
		i = encodeVarintClaimRecord(dAtA, i, uint64(m.VestedTier))
		i--
		dAtA[i] = 0x30
	}
	if len(m.DestAddress) > 0 {
		...
		i = encodeVarintClaimRecord(dAtA, i, uint64(len(m.DestAddress)))
		i--
		dAtA[i] = 0x2a
	}
	if m.ClaimTime != 0 {
...
func (m *ClaimRecord) Size() (n int) {
	...
	if m.VestedTier != 0 {
		n += 1 + sovClaimRecord(uint64(m.VestedTier))
	}
	return n
}
...
func (m *ClaimRecord) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VestedTier", wireType)
			}
			m.VestedTier = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VestedTier |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
