...
//
//	mockgen -copyright_file=../../../testutil/mock_header.txt -destination=../mocks/expected_keepers_mock.go -package=lumeraidmocks -source=expected_keepers.go
//
...
func (mr *MockBankKeeperMockRecorder) SendCoinsFromModuleToAccount(ctx, module, recipientAddress, amt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
