...
//
//	mockgen --copyright_file=../../../testutil/mock_header.txt -destination=../mocks/legroast_mocks.go -package=lumeraidmocks -source=legroast.go
//
...
func (mr *MockLegRoastInterfaceMockRecorder) Keygen(seed any) *gomock.Call {
...
func (mr *MockLegRoastInterfaceMockRecorder) SetPublicKey(pk any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLegRoastInterfaceMockRecorder) Sign(message any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLegRoastInterfaceMockRecorder) Verify(message, signature any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
