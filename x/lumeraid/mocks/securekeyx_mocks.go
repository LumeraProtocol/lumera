...
//
//	mockgen -copyright_file=../../../testutil/mock_header.txt -destination=../mocks/securekeyx_mocks.go -package=lumeraidmocks -source=securekeyx.go
//
...
func (mr *MockKeyExchangerMockRecorder) ComputeSharedSecret(handshakeBytes, signature any) *gomock.Call {
...
func (mr *MockKeyExchangerMockRecorder) CreateRequest(remoteAddress any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKeyExchangerValidatorMockRecorder) AccountInfoByAddress(ctx, addr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKeyExchangerValidatorMockRecorder) GetSupernodeBySupernodeAddress(ctx, address any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
